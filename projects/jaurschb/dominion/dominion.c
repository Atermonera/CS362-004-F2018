...
//check if pointers need to be added or some other change
...
int treasure_mapEffect(struct gameState *state, int currentPlayer, int handPos){
  int index;
  int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case minion:
      //Refactored
      return minionEffect(state, handPos, currentPlayer, choice1, choice2);
    ...
    case treasure_map:
      //Refactored
      return treasure_mapEffect(state, currentPlayer, handPos);
    }
