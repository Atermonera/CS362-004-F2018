...
int main() {
	...
	int result = cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	fFlag += asserttrue(result, 0,0);

	fFlag += asserttrue(testGame.handCount[testGame.whoseTurn], Game.handCount[Game.whoseTurn]+2, 1);
